...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def step(self, action: np.ndarray):
        ...
        4: left hip joint angle
        5: left hip joint speed
        6: left knee joint angle
        7: left knee joint speed
        8: left leg ground contact
        9: right hip joint angle
        10: right hip joint speed
        11: right knee joint angle
        12: right knee joint speed
        13: right leg ground contact
        '''
        #State reference
        state += [l.fraction for l in self.lidar]
        assert len(state) == 24
